...
add_action( 'wp_head', function () {
	if ( is_singular( 'job' ) ) {
		echo '<style>.bj-article { font-family: "Hiragino Kaku Gothic ProN","Hiragino Sans","Yu Gothic","Noto Sans JP","Meiryo",sans-serif; color:#2b2f36; line-height:1.9; font-size:15px; max-width:100%; margin:0; }
