...
- [x] ✅ 関東バス — `kanto-bus`(**2026-08-25 実データ化**。「たてバス」、夜行高速バス・空港バス等の実際の事業内容に基づく)
- [x] ✅ 東武バス — `tobu-bus`(**2026-08-25 実データ化**。電話番号は不明。東武バスセントラル/ウエスト/日光など複数グループ会社で構成される点を反映。東武鉄道とは別法人)
- [x] ✅ 小田急バス — `odakyu-bus`(**2026-08-25 実データ化**。高速・貸切バスは姉妹会社の小田急ハイウェイバスが担当である点を反映)
- [x] ✅ 京王バス — `keio-bus`(**2026-08-25 実データ化**。中央道方面の高速バス・貸切バス事業を反映。京王電鉄とは別法人)
- [x] ✅ 西東京バス — `nishitokyo-bus`(**2026-08-25 実データ化**。京王グループ、多摩西部・山梨県北東部が運行エリアである点を反映)
- [x] ✅ 都営バス — `toei-bus`(**2026-08-25 実データ化**。「都営バス運転手養成枠採用」制度・路線バス専業である点など、他社と共通の汎用文ではなく都営バス固有の事実に基づいて書き直し済み)
